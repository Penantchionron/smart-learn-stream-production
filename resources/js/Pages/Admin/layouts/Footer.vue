<template>
    <footer id="page-footer"
       class=" sticky overflow-y-hidden overflow-x-hidden bg-black flex grow-0 items-center border-t border-slate-200 dark:border-slate-700"
     >
         <div
       ...
       >
         <div class="inline-flex items-center align-center flex-col space-x-6 ">
