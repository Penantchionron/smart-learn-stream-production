<template>
    <footer id="page-footer"
       class=" sticky overflow-y-hidden bg-black flex grow-0 items-center border-t border-slate-200 dark:border-slate-700"
     >
         <div
         class="container mx-auto flex flex-col gap-2 px-4 py-6 text-center text-sm font-medium text-gray-600 md:flex-row md:justify-between md:gap-0 md:text-start lg:px-8 xl:max-w-7xl dark:text-gray-400"
       >
         <div class="inline-flex items-center align-center space-x-6 ">
             ...
             <span class="d:flex flex-row  text-amber-50 text-center">Smart Learn Stream</span>
         </a>
         </div>
       </div>
     </footer>
